...
let
  ...
  ferdiumLatest = pkgs.ferdium.overrideAttrs (oldAttrs: rec {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-5OW10sABNNYQNUgorM634j5oiBhJJby1ymH6UcmknRg=";
    };
  });
...
#  };
   temurin-bin-21-low = pkgs.temurin-bin-21.overrideAttrs(oldAttrs: { meta.priority = 5; });
...

{
  ...
  home.packages = [ pkgs._3proxy pkgs.adoptopenjdk-icedtea-web pkgs.akonadi pkgs.android-tools pkgs.ansible pkgs.appimage-run pkgs.asdf-vm pkgs.autojump pkgs.avrdude pkgs.aws-mfa pkgs.awscli2 pkgs.azure-cli pkgs.azure-functions-core-tools pkgs.azure-storage-azcopy pkgs.bisq-desktop pkgs.brave unstable.bruno pkgs.btop pkgs.byzanz pkgs.dart unstable.delve pkgs.dialog pkgs.docker-compose pkgs.dos2unix pkgs.drawio pkgs.drill pkgs.du-dust pkgs.ebusd pkgs.envsubst pkgs.evince pkgs.ffmpeg-full pkgs.filezilla pkgs.firebase-tools pkgs.fluent-bit pkgs.fluxctl pkgs.freecad pkgs.freerdp pkgs.ghostscript pkgs.git-crypt pkgs.git-filter-repo pkgs.glibc pkgs.gmp pkgs.gnome-network-displays pkgs.go-ethereum pkgs.google-drive-ocamlfuse pkgs.gron pkgs.grpc-gateway pkgs.grpc-tools pkgs.grpcurl pkgs.gsctl pkgs.gsettings-desktop-schemas pkgs.handbrake pkgs.hugo pkgs.hidapi pkgs.hugs pkgs.hunspell pkgs.hunspellDicts.de-de pkgs.hunspellDicts.en-us pkgs.hunspellDicts.de_DE pkgs.hyphen pkgs.imagemagick pkgs.insomnia pkgs.ipmitool pkgs.jameica pkgs.kalendar pkgs.kazam pkgs.kcalc pkgs.kdenlive unstable.keepassxc pkgs.kphotoalbum pkgs.krusader pkgs.kteatime pkgs.ktorrent pkgs.lapce pkgs.libreoffice-fresh (lib.hiPrio pkgs.localsend) pkgs.mediathekview pkgs.monero-gui pkgs.mosh pkgs.mupdf pkgs.mycrypto pkgs.nextcloud-client pkgs.nix-bundle pkgs.nixpkgs-fmt pkgs.nodejs pkgs.oathToolkit pkgs.ocrmypdf pkgs.ollama pkgs.onlyoffice-bin pkgs.openshot-qt pkgs.openssl pkgs.outils pkgs.paperwork pkgs.pavucontrol pkgs.pdfarranger pkgs.pdfgrep pkgs.pdfsam-basic pkgs.pdsh pkgs.peek pkgs.pinta pkgs.pkgsCross.avr.buildPackages.gcc pkgs.platformio pkgs.postgresql_14 pkgs.proto-contrib pkgs.protoc-gen-go pkgs.protoc-gen-go-grpc pkgs.protoc-gen-validate pkgs.pssh pkgs.pwgen pkgs.python39Full pkgs.qpdf pkgs.qrencode pkgs.rbenv pkgs.rclone pkgs.regclient pkgs.regsync pkgs.ripgrep pkgs.rpi-imager pkgs.rpl pkgs.rpmextract pkgs.ruby unstable.rustdesk-flutter pkgs.siege pkgs.signal-desktop pkgs.sipcalc pkgs.socat pkgs.sops pkgs.spectral pkgs.sshpass pkgs.sshuttle pkgs.stoken pkgs.swaks pkgs.thunderbird-128 pkgs.unetbootin pkgs.untrunc pkgs.usbtop pkgs.viu pkgs.vscodium pkgs.wine pkgs.winetricks pkgs.x2goclient pkgs.xdotool pkgs.xorg.xhost pkgs.xsel pkgs.xsv pkgs.yarn2nix pkgs.ydotool pkgs.zip pkgs.zlib ferdiumLatest python39Packages.pip python39Packages.virtualenv temurin-bin-17-low temurin-bin-21-low adoptopenjdk-hotspot-bin-8-low adoptopenjdk-hotspot-bin-11-low (google-cloud-sdk.withExtraComponents [google-cloud-sdk.components.gke-gcloud-auth-plugin]) ];
  # unstable.hoppscotch
...
#  };
  ...
  home.sessionVariables = {
    ...
    JAVA_21_HOME = "${temurin-bin-21-low}";
    JAVA_HOME = "${temurin-bin-21-low}";
