...
let
  ...
  ferdiumLatest = pkgs.ferdium.overrideAttrs (oldAttrs: rec {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-ZCyAz+XVp2NJVUuMWyv5ubjMaoYBsjPAye/1vO2jv/w=";
    };
  });
