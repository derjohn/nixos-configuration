...
let
  ...
  ferdiumLatest = pkgs.ferdium.overrideAttrs (oldAttrs: rec {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-gx8tDGb2yjwexChZGJ9RdVbgseDByFeW2ZR1RebjlO4=";
    };
  });
