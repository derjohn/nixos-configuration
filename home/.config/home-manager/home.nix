...
let
  ...
  ferdiumLatest = pkgs.ferdium.overrideAttrs (oldAttrs: rec {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-e5O8cvQqvymHQiu7kY1AhKfoVOsDLYK8hDX+PKgZPFs=";
    };
  });
